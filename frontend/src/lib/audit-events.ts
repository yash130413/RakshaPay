...
const EVENT_META: Record<string, AuditEventMeta> = {
  ...
  "review.assigned": { icon: Shield, label: "Reviewer assigned", tone: "escalate" },
  "review.approved": { icon: CheckCircle2, label: "Human approved", tone: "recovery" },
  "review.rejected": { icon: XCircle, label: "Human rejected", tone: "reject" },
  "review.info_requested": { icon: AlertTriangle, label: "Info requested", tone: "escalate" },
